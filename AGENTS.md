...
- Do not mix unrelated workstreams on the same branch. If backend, infrastructure, or unrelated feature work appears during a UI task, move it to a dedicated branch before merging.
